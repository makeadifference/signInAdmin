...
class searchStudentVC: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //let frame = CGRect(x: 0, y: 5, width: self.view.frame.width, height: 40)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "resultCell", for: indexPath) as! studentCell
        // Configure the cell...
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let setClassVC = storyboard?.instantiateViewController(withIdentifier: "setClassVC") as! studentClassSettingVC
        setClassVC.id = id!
        self.navigationController?.pushViewController(setClassVC, animated: true)
    }
...
extension searchStudentVC : UISearchBarDelegate {
